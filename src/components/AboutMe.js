    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16">
          ...
          {/* Text Content */}
          <div className="w-full lg:w-1/2 text-center lg:text-left  bg-white/4 backdrop-blur-sm border-1 border-gray-500 text-gray-300 rounded-3xl hover:bg-white/20 p-4 transition-all duration-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 font-semibold  bg-white/6 backdrop-blur-sm border-1 border-gray-500 text-gray-300 rounded-3xl hover:bg-white/20 p-4 transition-all duration-300"
              >
                <DownloadIcon />
                Download Resume
              </a>
